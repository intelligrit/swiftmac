...
1. Clone the repository:
   #+BEGIN_SRC shell
   git clone https://github.com/intelligrit/swiftmac.git
   cd swiftmac
   #+END_SRC
...
- GitHub Issues: https://github.com/intelligrit/swiftmac/issues
- Discussion: https://github.com/intelligrit/swiftmac/discussions
